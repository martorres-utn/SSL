...
|-------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Estado como "Constante simbólica #define"** | La definición como constante simbólica #define permite concentrar en una sola región del programa las definiciones de estados, esto es útil en caso de que se requiera cambiar el valor de un estado o incorporar nevos estados.                                                                                                                                                  | El estado es un valor constante que se define con instrucciones de preprocesamiento: es decir que no existe como un tipo en el programa, sólo como una interpretación. La variable que guarda el estado puede admitir otros valores enteros que podrían no ser un estado válido, esto no debería ocurrir en la lógica del programa pero no hay ninguna restricción que impida de asignar un entero cualquiera a la variable estado. |
| **Estado como "enum"**                        | La definición como enum permite concentrar en una sóla región del programa la definición de los estados posibles. Esto permite agregar, remover o editar estados más facilmente. El estado ahora es un tipo de dato. No debería ser posible que la variable estado contenga un valor que no fuera un estado válido. Sólo puede contener valores definidos dentro del enum estado. | -                                                                                                                                                                                                                                                                                                                                                                                                                                   |
